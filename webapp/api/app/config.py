...
# GRU4Rec architecture — must match how it was trained (notebook 07).
GRU_HIDDEN = 64
GRU_MAX_LEN = 30
...
# Session personalization: fraction of the recommendation feed given to items
# content-similar to the user's recent in-session activity (likes/cart/views/searches).
